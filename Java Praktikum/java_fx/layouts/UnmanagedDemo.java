...
public class UnmanagedDemo extends Application {
	...
	public void start(Stage primaryStage) {
		...
		text.resizeRelocate(40, 60, 450, 200);
	...
	private Node createChart() {
		...
		ObservableList<XYChart.Series<Double, Double>> lineChartData = FXCollections.observableArrayList(
				new LineChart.Series<Double, Double>("Serie 1",
				...
				new LineChart.Series<Double, Double>("Serie 2",
