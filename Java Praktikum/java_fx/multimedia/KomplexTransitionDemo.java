...
public class KomplexTransitionDemo extends Application {
	...
	public void start(Stage primaryStage) {
		...
		SequentialTransition sequential = new SequentialTransition(scale1, pause, scale2);

		ParallelTransition parallel = new ParallelTransition(circle, translate, sequential);
